...
DIPUTACIONES_VA_LAYOUT_PATH = os.path.join('Archivos', 'Datos', 'Diputaciones', 'diputacionesva_layout.xlsx')
DIPUTACIONES_VA_VOTOS_PATH = os.path.join('Archivos', 'Datos', 'Diputaciones', 'diputacionesva_layout_votos.xlsx')
DIPUTACIONES_VA_PDF_FORMAT_PATH = os.path.join('Archivos', 'Formatos', 'VA-DIP.pdf')
FONT_PATH = os.path.join('Archivos', 'Fonts', 'LetraBrenda-Regular.otf')
DIPUTACIONES_VA_PDF_DIR = os.path.join('Actas', 'Diputaciones_va', 'PDF')
DIPUTACIONES_VA_JPG_DIR = os.path.join('Actas', 'Diputaciones_va', 'JPG')

# Generar el archivo de votos a partir del layout
process_excel_file(DIPUTACIONES_VA_LAYOUT_PATH, DIPUTACIONES_VA_VOTOS_PATH)

# Leer el archivo Excel
df = pd.read_excel(DIPUTACIONES_VA_VOTOS_PATH, dtype={
...
pdf_base_path = DIPUTACIONES_VA_PDF_FORMAT_PATH

# Crear directorio para guardar los archivos generados
os.makedirs(DIPUTACIONES_VA_PDF_DIR, exist_ok=True)
os.makedirs(DIPUTACIONES_VA_JPG_DIR, exist_ok=True)
...
column_areas = {
    ...
    "LETRA2": (90, 370),
    "TOTAL_PERSONAS_VOTARON": (26, 370),
    "LETRA3": (90, 462),
    "SOBRES_VOTO": (26, 462),
    "LETRA4": (90, 554),
    "TOTAL_VOTOS_ASENTADO": (26, 554),
    #"LETRA4": (90, 585),
...
for index, row in df.iterrows():
    try:
        ...
        os.makedirs(os.path.join(DIPUTACIONES_VA_JPG_DIR, nombre_estado_final), exist_ok=True)
        ...
        #pdf_output_path = os.path.join(DIPUTACIONES_VA_PDF_DIR, f"{nombre_archivo}.pdf")
        ...
        jpg_path = os.path.join(os.path.join(DIPUTACIONES_VA_JPG_DIR, nombre_estado_final), f"va_{nombre_estado_final}{nombre_archivo2}.jpg")
...
print(f"PDFs y JPGs generados y guardados en '{DIPUTACIONES_VA_PDF_DIR}' y '{DIPUTACIONES_VA_JPG_DIR}'.")
