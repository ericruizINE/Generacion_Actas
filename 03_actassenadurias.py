...
column_areas = {
    "NOMBRE_ESTADO": (70, 269), 
    "ID_DISTRITO": (360, 269),
    "SECCION": (75, 325),
    "DATOS_QR": (250, 18),  # Añadir posición para el QR
    "CASILLA": (365, 55),
    "LETRA1": (40, 477),
    "BOLETAS_SOBRANTES": (338, 477),
    "LETRA2": (40, 564),
...
for index, row in df.iterrows():
    try:
        ...
        pdf_output_path = os.path.join(SENADURIAS_PDF_DIR, f"3V1-{fecha_actual}_{index + 1}.pdf")
        pdf_document.save(pdf_output_path)
        print(f"Archivo generado: 3V1-{fecha_actual}_{index + 1}.pdf")
        ...
        jpg_path = os.path.join(SENADURIAS_JPG_DIR, f"0101-3V1-{fecha_actual}_{index + 1}.jpg")
        print(f"Archivo generado: 0101-3V1-{fecha_actual}_{index + 1}.jpg")
...
print("PDFs y JPGs generados y guardados en las carpetas 'PDF/senadurias' y 'JPG/senadurias.")
